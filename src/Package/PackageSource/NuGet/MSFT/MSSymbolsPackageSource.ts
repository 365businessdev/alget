...
export class MSSymbolsPackageSource implements IPackageSource {
    /// <summary>
    ...
    /// </summary>
    public WebsiteUrl: string = 'https://dev.azure.com/dynamicssmb2/DynamicsBCPublicFeeds/_artifacts/feed/MSSymbols';
